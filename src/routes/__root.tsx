...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Qeemat — AI Price Tracker for Pakistan" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Qeemat — AI Price Tracker for Pakistan" },
      {
      ...
      { name: "twitter:title", content: "Qeemat — AI Price Tracker for Pakistan" },
